...
public class VideoPlayActivity extends AppCompatActivity {
    ...
    public void setVideo() {
        ...
        videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                video_index++;
                if (video_index < (PlayVideo.videoArrayList.size())) {
    ...
    public void playVideo(int pos) {
        try  {
            videoView.setVideoURI(PlayVideo.videoArrayList.get(pos).getVideoUri());
            videoView.start();
        ...
        prev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (video_index > 0) {
                    ...
                    video_index = PlayVideo.videoArrayList.size() - 1;
                    playVideo(video_index);
                }
            }
        });
    ...
    public void nextVideo() {
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (video_index < (PlayVideo.videoArrayList.size()-1)) {
                    video_index++;
                    playVideo(video_index);
                } else {
                    video_index = 0;
